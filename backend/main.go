...
func (s *server) routes() http.Handler {
	...
	mux.HandleFunc("GET /api/agent/ssh-hosts", s.requireAuth(s.handleAgentSSHHostsList))
	mux.HandleFunc("PUT /api/agent/ssh-hosts", s.requireAuth(s.handleAgentSSHHostUpsert))
	mux.HandleFunc("DELETE /api/agent/ssh-hosts/{alias}", s.requireAuth(s.handleAgentSSHHostDelete))
